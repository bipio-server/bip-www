define([
  'underscore',
  'backbone',
  'models/m_channel_log',
  'bipclient'
  ], function(_, Backbone, ChannelLogModel, BipClient) {
    var ChannelLogCollection = Backbone.Collection.extend({
      model: ChannelLogModel,
      ...
      initialize : function(channelId) {
        ...
        BipClient.setCollection('channel_log', this);
        this.channelId = channelId;
      },

      url: function() {
        return BipClient.getResourceName(
          'channel/' + this.channelId + '/logs',
          this.page,
          this.page_size,
          this.sortBy
          );
